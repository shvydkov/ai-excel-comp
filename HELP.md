...
* The original package name 'com.example.ai-test' is invalid and this project uses 'com.example.ai_test' instead.
...
```
$ docker run --rm -p 8080:8080 ai-test:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/ai-test
```
